...
//@Slf4j
//@Component
//public class ElasticsearchUtil2 {
//
...
//        if (log.isDebugEnabled()) {
//        	log.debug("执行建立成功？{}", indexresponse.isAcknowledged());
//		}
...
//            if (log.isDebugEnabled()) {
//        		log.debug("delete index {} successfully!", index);
//			}
//        } else {
//        	if (log.isDebugEnabled()) {
//        		log.debug("Fail to delete index {}", index);
//			}
//        }
...
//        if (log.isDebugEnabled()) {
//        	log.debug("addData response status:{}, id:{}", response.status().getStatus(), response.getId());
//		}
