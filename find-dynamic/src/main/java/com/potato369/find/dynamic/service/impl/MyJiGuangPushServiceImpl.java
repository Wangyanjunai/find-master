...
public class MyJiGuangPushServiceImpl implements MyJiGuangPushService {
	...
	public boolean pushAll(PushBean pushBean) {
		return sendPush(PushPayload.newBuilder().setPlatform(Platform.all()).setAudience(Audience.all())
				.setNotification(Notification.alert(pushBean.getAlert())).build());
	}
	...
	public boolean pushIos(PushBean pushBean) {
		return sendPush(PushPayload.newBuilder().setPlatform(Platform.ios()).setAudience(Audience.all())
				.setNotification(Notification.ios(pushBean.getAlert(), pushBean.getExtras())).build());
	}
	...
	public boolean pushIos(PushBean pushBean, String... registids) {
		return sendPush(
				PushPayload.newBuilder().setPlatform(Platform.ios()).setAudience(Audience.registrationId(registids))
						.setNotification(Notification.ios(pushBean.getAlert(), pushBean.getExtras())).build());
	}
	...
	public boolean pushAndroid(PushBean pushBean) {
		return sendPush(PushPayload.newBuilder().setPlatform(Platform.android()).setAudience(Audience.all())
	...
	public boolean pushAndroid(PushBean pushBean, String... registids) {
		return sendPush(PushPayload.newBuilder().setPlatform(Platform.android())
	...
	@Override
	public boolean pushAndroidAlias(PushBean pushBean, String alias, String content) {
		return sendPush(PushPayload.newBuilder().setPlatform(Platform.android())
		.setAudience(Audience.alias(alias))
        .setNotification(Notification.newBuilder()
                .addPlatformNotification(IosNotification.newBuilder().setAlert(pushBean.getAlert())
                        .addExtra("content", content).addExtras(pushBean.getExtras()).build())
                .addPlatformNotification(AndroidNotification.newBuilder().setAlert(pushBean.getAlert())
                        .addExtra("content", content).setTitle(pushBean.getTitle()).addExtras(pushBean.getExtras()).build())
                .addPlatformNotification(WinphoneNotification.newBuilder().setAlert(pushBean.getAlert())
                        .addExtra("content", content).addExtras(pushBean.getExtras()).build())
                .build())
        .build());
	}
	...
	@Override
	public boolean pushIosAlias(PushBean pushBean, String alias, String content) {
