...
public class JPushUtil {
    ...
    public static void main(String[] args) {
    	// vivo
        sendPushNotice("1507bfd3f76139cd43a", null, "系统通知31", "类型", "觅鹿通知31", "content");
        // xiaomi
        sendPushNotice("13065ffa4ead6656765", null, "系统通知31", "类型", "觅鹿通知31", "content");
    }
}
