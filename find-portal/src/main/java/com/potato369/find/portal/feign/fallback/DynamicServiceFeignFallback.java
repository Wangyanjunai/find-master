...
public class DynamicServiceFeignFallback implements DynamicService {
    ...
    @Override
    public CommonResult<Map<String, Object>> applyToAddWechatByUserId(Long applicantUserId, Long applicantsUserId, String message) {
        log.error("进入了熔断器方法！！！");
        return CommonResult.failed("fallback; reason was: 服务忙，稍后重试！");
    }

    @Override
    public CommonResult<Map<String, Object>> checkResult(String content) {
        log.error("进入了熔断器方法！！！");
        return CommonResult.failed("fallback; reason was: 服务忙，稍后重试！");
    }

    @Override
    public CommonResult<Map<String, Object>> getDynamicByUserId(Long id, Long id2, int pageNum, int pageSize) {
        log.error("进入了熔断器方法！！！");
        return CommonResult.failed("fallback; reason was: 服务忙，稍后重试！");
    }

    @Override
    public CommonResult<Map<String, Object>> topping(Long userId, String type, Long dynamicInfoId) {
        log.error("进入了熔断器方法！！！");
        return CommonResult.failed("fallback; reason was: 服务忙，稍后重试！");
    }
}
