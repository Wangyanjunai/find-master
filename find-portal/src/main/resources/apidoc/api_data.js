define({ "api": [
  ...
  {
    "type": "put",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/delete",
    "title": "删除动态内容接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "删除动态内容",
  ...
  {
    "type": "post",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/updateLocation",
    "title": "更新动态地址定位接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "更新动态地址定位",
  ...
  {
    "type": "post",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/checkLocation",
    "title": "检查定位地址是否更改接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "检查定位地址是否更改",
  ...
  {
    "type": "put",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/likes",
    "title": "点赞或取消点赞接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "点赞或取消点赞",
      ...
      "fields": {
        "接口请求参数": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>类型，0-&gt;取消点赞，1-&gt;点赞</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "请求示例01（取消点赞，点赞记录不存在）",
  ...
  {
    "type": "put",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/application",
    "title": "申请加微信接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "申请加微信",
        ...
        "接口请求参数": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>用户id，说明：普通用户每天只允许申请最多5次添加微信，VIP用户申请加微信次数没有限制</p>"
          },
          {
            "group": "接口请求参数",
            "type": "long",
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/screen",
    "title": "筛选动态内容列表接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "筛选动态内容列表",
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/mylist",
    "title": "获取自己的动态内容列表接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "获取自己的动态内容列表",
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/dynamic/{id}/list",
    "title": "觅鹿主界面动态内容列表接口",
    "version": "1.0.0",
    "group": "动态模块API",
    "name": "觅鹿主界面动态内容列表",
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例",
          "content": "HTTP/1.1 OK\ncurl -v -X PUT http://124.71.38.2:8081/find/v1/user/70/uploadRegId.do?regId=1507bfd3f76139cd43a",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "put",
    "url": "http://124.71.38.2:8084/find/user/{id}/head",
    "title": "修改头像接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "修改头像",
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "200响应示例",
          "content": "HTTP/1.1 200 OK\n\t\t{\n\t\t    \"status\": 200,\n\t\t    \"code\": 0,\n\t\t    \"msg\": \"返回数据成功\",\n\t\t    \"data\": {\n\t\t        \"head\": \"http://124.71.38.2:9000/find/img/head/2b9c022d-ec00-497c-9626-813add17b877_admin069.jpg\",\n\t\t        \"id\": 1\n\t\t    }\n\t\t}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "put",
    "url": "http://124.71.38.2:8084/find/user/{id}/background",
    "title": "修改背景图接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "修改背景图",
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "200响应示例",
          "content": "HTTP/1.1 200 OK\n\t\t{\n\t\t    \"status\": 200,\n\t\t    \"code\": 0,\n\t\t    \"msg\": \"返回数据成功\",\n\t\t    \"data\": {\n\t\t        \"bg\": \"http://124.71.38.2:9000/find/img/head/2b9c022d-ec00-497c-9626-813add17b877_admin069.jpg\",\n\t\t        \"id\": 1\n\t\t    }\n\t\t}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/user/isreg?phone={手机号码}",
    "title": "判断手机号是否注册接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "判断手机号是否注册",
      ...
      "examples": [
        {
          ...
          "content": "HTTP/1.1 OK\ncurl -v -X GET http://124.71.38.2:8081/find/user/isreg?phone=18138802541",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "post",
    "url": "http://124.71.38.2:8084/find/user/{id}/pushOrPull",
    "title": "拉入推出黑名单接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "拉入推出黑名单接口",
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例",
          "content": "HTTP/1.1 OK\ncurl --insecure -X POST -v http://124.71.38.2:8084/find/user/1/pushOrPull -H \"Content-Type: application/json;charset=UTF-8\" -d '{\"blackUserId\":2, \"type\":0}'",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "put",
    "url": "http://124.71.38.2:8084/find/user/{id}/update",
    "title": "更新用户资料接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "更新用户资料",
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例 修改昵称",
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/{id}/update -H \"Content-Type: application/json;;charset=UTF-8\" -d '{\"nickname\":\"王6\"}'",
          "type": "json"
        },
        {
          "title": "请求示例 修改微信号",
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/{id}/update -H \"Content-Type: application/json;charset=UTF-8\" -d '{\"weixinId\":\"12622\"}'",
          "type": "json"
        },
        {
          "title": "请求示例 修改出生年月日和星座",
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/{id}/update -H \"Content-Type: application/json;charset=UTF-8\" -d '{\"year\":\"1996\", \"month\":\"08\", \"date\":\"03\", \"constellation\":\"双子座\"}'",
          "type": "json"
        },
        {
          "title": "请求示例 修改签名",
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/{id}/update -H \"Content-Type: application/json;charset=UTF-8\" -d '{\"autograph\":\"12622\"}'",
          "type": "json"
        },
        {
          "title": "请求示例 修改签名和出生年月日，星座",
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/{id}/update -H \"Content-Type: application/json;charset=UTF-8\" -d '{\"autograph\":\"126我的2\", \"year\":\"1996\", \"month\":\"08\", \"date\":\"03\", \"constellation\":\"水平座\"}'",
          "type": "json"
        },
        {
          "title": "请求示例 修改签名，出生年月日，星座，昵称，微信号",
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/{id}/update -H \"Content-Type: application/json;charset=UTF-8\" -d '{\"nickname\":\"王666\", \"weixinId\":\"12622www\", \"autograph\":\"126我的ss2\", \"year\":\"1996\", \"month\":\"08\", \"date\":\"03\", \"constellation\":\"射手座\"}'",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/user/{id}/queryWeixin",
    "title": "查看用户微信号接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "查看用户微信号",
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例 修改昵称",
          "content": "HTTP/1.1 OK\ncurl --insecure -X GET -v http://124.71.38.2:8084/find/user/1/queryWeixin",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/user/{id}/query.do",
    "title": "查看用户资料接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "查看用户资料",
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例 获取用户资料",
          "content": "HTTP/1.1 OK\ncurl --insecure -X GET -v http://124.71.38.2:8084/find/user/1/query",
          "type": "json"
        }
      ]
    },
    "success": {
      ...
      "examples": [
        {
          "title": "200响应示例",
          "content": "HTTP/1.1 200 OK\n\t\t{\n\t\t    \"status\": 200,\n\t\t    \"code\": 0,\n\t\t    \"msg\": \"查看用户个人资料成功\",\n\t\t    \"data\": {\n\t\t        \"user\": {\n\t\t            \"id\": 1,\n\t\t            \"nickname\": \"王666\",\n\t\t            \"head\": \"http://124.71.38.2:9000/find/img/head/2b9c022d-ec00-497c-9626-813add17b877_admin069.jpg\",\n\t\t            \"bg\": \"http://124.71.38.2:9000/find/img/background/a1bf6181-ebd0-43b4-8e91-761ec8fc83ab_admin055.jpg\",\n\t\t            \"grade\": 0,\n\t\t            \"age\": 24,\n\t\t            \"gender\": \"1\",\n\t\t            \"autograph\": \"126我的ss2\"\n\t\t        }\n\t\t    }\n\t\t}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "post",
    "url": "http://124.71.38.2:8084/find/user/{id}/report",
    "title": "用户举报接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "用户举报",
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例 查看用户举报类型",
          "content": "HTTP/1.1 OK\ncurl --insecure -X POST -v http://124.71.38.2:8084/find/user/{id}/report -H \"Content-Type: application/json;charset=UTF-8\" -d '{\"categoryId\":1, \"reportType\":1, \"beingReportId\":3, \"reportContent\":\"老是打广告dddddd+++++++！！！！！\"}'",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "post",
    "url": "http://124.71.38.2:8084/find/user/reg",
    "title": "用户注册接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "用户注册",
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "200响应示例",
          "content": "HTTP/1.1 200 OK\n\t\t{\n\t\t    \"status\": 200,\n\t\t    \"code\": 0,\n\t\t    \"msg\": \"登录或者注册成功。\",\n\t\t    \"data\": {\n\t\t        \"user\": {\n\t\t            \"id\": 21,\n\t\t            \"gender\": \"1\",\n\t\t            \"nickname\": \"张三\",\n\t\t            \"head\": \"http://124.71.38.2:9000/find/img/head/head.png\",\n\t\t            \"bg\": \"http://124.71.38.2:9000/find/img/background/bg.png\",\n\t\t            \"autograph\": \"新人小生，初来乍到，请多关照。\"\n\t\t        }\n\t\t    }\n\t\t}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "put",
    "url": "http://124.71.38.2:8084/find/user/login",
    "title": "用户登录接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "用户登录",
      ...
      "examples": [
        {
          ...
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/login?phone=18138812310&ip=183.14.29.70",
          "type": "json"
        },
        {
          "title": "请求示例02（手机号码和定位地址登录）",
          "content": "HTTP/1.1 OK\ncurl --insecure -X PUT -v http://124.71.38.2:8084/find/user/login?phone=18138812236&country=中国&province=广东省&city=深圳市",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/user/{id}/report-categories",
    "title": "获取用户举报类型接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "获取用户举报类型",
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例 查看用户举报类型",
          "content": "HTTP/1.1 OK\ncurl --insecure -X GET -v http://124.71.38.2:8084/find/user/1/report-categories",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8084/find/user/{id}/blacklist?pageNum={pageNum}&pageSize={pageSize}",
    "title": "获取用户黑名单列表接口",
    "version": "1.0.0",
    "group": "用户模块API",
    "name": "获取用户黑名单列表接口",
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例 查看用户举报类型",
          "content": "HTTP/1.1 OK\ncurl --insecure -X GET -v http://124.71.38.2:8084/find/user/1/blacklist?pageNum=1&pageSize=10",
          "type": "json"
        }
      ]
    },
    "success": {
      ...
      "examples": [
        {
          "title": "200响应示例",
          "content": "HTTP/1.1 200 OK\n\t\t{\n\t\t    \"status\": 200,\n\t\t    \"code\": 0,\n\t\t    \"msg\": \"获取用户黑名单列表成功。\",\n\t\t    \"data\": {\n\t\t        \"totalPage\": 2,\n\t\t        \"list\": [\n\t\t            {\n\t\t                \"id\": 12,\n\t\t                \"nickname\": \"陆蕙兰\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/12.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:25:27\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 11,\n\t\t                \"nickname\": \"商梓珊\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/11.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:51\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 10,\n\t\t                \"nickname\": \"赫飞雨\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/10.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:47\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 9,\n\t\t                \"nickname\": \"寒烟\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/09.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:42\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 7,\n\t\t                \"nickname\": \"勾高朗\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/07.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:30\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 6,\n\t\t                \"nickname\": \"慕蕊\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/06.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:24\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 5,\n\t\t                \"nickname\": \"庾音韵\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/05.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:19\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 4,\n\t\t                \"nickname\": \"覃星宇\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/04.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:14\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 3,\n\t\t                \"nickname\": \"致命德毒药\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/03.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:08\"\n\t\t            },\n\t\t            {\n\t\t                \"id\": 2,\n\t\t                \"nickname\": \"千柳\",\n\t\t                \"head\": \"http://192.168.31.30:9000/find/img/head/02.jpg\",\n\t\t                \"time\": \"2021年01月22日 15:24:02\"\n\t\t            }\n\t\t        ]\n\t\t    }\n\t\t}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "post",
    "url": "http://124.71.38.2:8084/find/v1/order/{id}/mobile/create.do",
    "title": "创建预支付订单接口",
    "version": "1.0.0",
    "group": "订单模块API",
    "name": "创建预支付订单",
  ...
  {
    "type": "get",
    "url": "http://124.71.38.2:8086/find/v1/order/{id}/product/list.do",
    "title": "获取充值商品列表接口",
    "version": "1.0.0",
    "group": "订单模块API",
    "name": "获取充值商品列表",
