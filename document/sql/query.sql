...
SELECT * FROM `application_record` WHERE `user_id` = 60;

SELECT * from `message` WHERE `send_user_id` = 60;


SELECT * FROM `message`;

SELECT * FROM `application_record` WHERE `user_id` = 111 AND `reserve_column01` = 131;


SELECT * FROM `user` WHERE `id` = 135;

SELECT * FROM tag;

SELECT * FROM `dynamic_info` WHERE `user_id` = 70 ORDER BY create_time DESC;
SELECT * from `dynamic` where id = 251;
